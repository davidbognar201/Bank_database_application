...
namespace BankApplication.Test
{
    public class CustomerLogicTester
    {
        ...
        public void Init()
        {
            ...
            BankCard mockCard4 = new BankCard(4, "2342-3242-9732-3222", "MasterCard", false, 3);
            BankCard mockCard5 = new BankCard(5, "2342-3242-9732-4443", "MasterCard", false, 3);
            BankCard mockCard6 = new BankCard(6, "5234-2323-9732-6642", "MasterCard", false, 3);
        ...
        [Test]
        public void GetCustomersByCardCountWithValidArgumentsTest()
        {
            var expectedWithArgumentOne = new List<Customer>(){
                new Customer(4, "Customer Four", 2000, 3, 10000, "Hungary")
            };
            var expectedWithArgumentThree = new List<Customer>();
            var expectedWithArgumentZero = new List<Customer>()
            {
                new Customer(1, "Customer One", 2000, 3, 10000, "Hungary"),
                new Customer(2, "Customer Two", 2000, 3, 10000, "Austria"),
                new Customer(3, "Customer Three", 2000, 3, 10000, "Croatia"),
                new Customer(4, "Customer Four", 2000, 3, 10000, "Hungary")
            };

            var resultWithArgumentOne = mockCustomerLogic.GetCustomersByCardCount(1);
            var resultWithArgumentThree = mockCustomerLogic.GetCustomersByCardCount(3);
            var resultWithArgumentZero = mockCustomerLogic.GetCustomersByCardCount(0);


            CollectionAssert.AreEqual(expectedWithArgumentOne, resultWithArgumentOne);
            CollectionAssert.AreEqual(expectedWithArgumentThree, resultWithArgumentThree);
            CollectionAssert.AreEqual(expectedWithArgumentZero, resultWithArgumentZero);
        }
    }
}
