...
namespace BankApplication.Test
{
    ...
    public class BankCardLogicTester
    {
        ...
        public void Init()
        {
            BankCard mockCard1 = new BankCard(1, "5323-4234-3234-2122", "Visa", false, 1);
            BankCard mockCard2 = new BankCard(2, "4343-5425-1123-8533", "MasterCard", false, 2);
            BankCard mockCard3 = new BankCard(3, "5323-2333-2355-6424", "Visa", true, 2);
            BankCard mockCard4 = new BankCard(4, "2342-3242-9732-4443", "MasterCard", false, 3);
            BankCard mockCard5 = new BankCard(5, "2342-3242-9732-4443", "MasterCard", false, 3);
        ...
        {
            var bankCard = new BankCard() { CardId = 5, CardNumber = "asd1-4232-4444-3131", IsBlocked = false, AttachedAccountId = 4, Type = "Visa" };
        ...
        {
            var bankCard = new BankCard() { CardId = 5, CardNumber = "1111-4232-4444-3131-", IsBlocked = false, AttachedAccountId = 4, Type = "Visa" };
        ...
        {
            var bankCard = new BankCard() { CardId = 5, CardNumber = "7342-4232-4444-3131", IsBlocked = false, AttachedAccountId = 4, Type = "Visa" };
            try
            {
                bankCardLogic.Create(bankCard);
            }
        ...
        public void AggregateCardsByCountryTestWithCardTypeEqualsAllArguments()
        {
            ...
            {
                new CardInfoByCountry() {CountryName = "Albania", AllCardAmount = 1, BlockedCardAmount = 0},
                new CardInfoByCountry() {CountryName = "USA", AllCardAmount = 4, BlockedCardAmount = 1}
        ...
        public void AggregateCardsByCountryTestWithCardTypeEqualsVisaArguments()
        {
            ...
            {
                new CardInfoByCountry() {CountryName = "Albania", AllCardAmount = 1, BlockedCardAmount = 0},
                new CardInfoByCountry() {CountryName = "USA", AllCardAmount = 1, BlockedCardAmount = 1}
        ...
        public void AggregateCardsByCountryTestWithCardTypeEqualsMastercardArguments()
        {
            ...
            {
                new CardInfoByCountry() {CountryName = "USA", AllCardAmount = 3, BlockedCardAmount = 0}
